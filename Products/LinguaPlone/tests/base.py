...
deprecated('Please import TestCase class from Products.LinguaPlone.testing',
           LinguaPloneTestCase='Products.LinguaPlone.testing:LinguaPloneTestCase',
           LinguaPloneFunctionalTestCase='Products.LinguaPlone.testing:LinguaPloneFunctionalTestCase')
